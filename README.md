...
This software allows you to sell virtual instances for Bitcoin:
...
It is my belief that crypto currency technologies can bring a new knob to the existing cloud offerings of **compute**, **storage**, and **network**.  That new knob is essentially what crypto currencies embody: **trust** through a trusted ledger of accounts called the blockchain.  While conversations about how crypto currencies affect our financial systems are definitely interesting, paying for additional **compute** with stored **trust**, previously computed by other compute, is an awe inspiring vision of the future.
