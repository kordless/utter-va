...
It is my belief that crypto currency technologies can bring a new knob to the existing cloud offerings of **compute**, **storage**, and **network**.  That new knob is essentially what crypto currencies provide: computed trust, or simply **trust**.  While conversations about how crypto currencies affect our financial systems are definitely interesting, the idea of paying for **compute** with **trust** previously computed by other compute is just downright awe inspiring.
